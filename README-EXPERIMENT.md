...
This repository extends the [URL shortener microservices demo](README.md) into an experiment that compares two Kubernetes autoscalers on the same workload:
...
For the original application (Go, Python, Node and Redis services, the dashboard and the API), see [README.md](README.md).
...
├── README.md                     Original app documentation (upstream)
├── README-EXPERIMENT.md          This file
